...
@router.post("/create")
def create_todo(todo_model: TodoCreateModel, service: TodoService = Depends(get_todo_service)):
...
@router.put("/update")
def update_todo( todo_model: TodoModel, service: TodoService = Depends(get_todo_service)):
